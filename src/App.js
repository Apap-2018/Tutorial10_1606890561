...
import { AddHasilLab } from './screens/AddHasilLab';
				...
				<div className="App">
					...
					<div className="container">
						<Switch>
							...
							<Route path="/all-staff-farmasi" exact component={DaftarStafFarmasi} />
							<Route path="/update-pasien/:id" exact component={UpdatePasien} />
							<Route path="/addHasilLab-pasien/" exact component={AddHasilLab} />
